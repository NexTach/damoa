package io.github.snowykte0426.damoa.auth.controller

import io.github.snowykte0426.damoa.auth.repository.OAuthStateStore
import io.github.snowykte0426.damoa.auth.service.DataGsmClient
import io.github.snowykte0426.damoa.auth.service.JwtService
...
private fun randomToken(bytes: Int): String =
    ByteArray(bytes).also { RANDOM.nextBytes(it) }.let { B64URL.encodeToString(it) }
