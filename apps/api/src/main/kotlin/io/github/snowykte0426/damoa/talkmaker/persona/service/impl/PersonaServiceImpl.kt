package io.github.snowykte0426.damoa.talkmaker.persona.service.impl
...
import io.github.snowykte0426.damoa.talkmaker.persona.dto.response.toResponse
...
import io.github.snowykte0426.damoa.talkmaker.persona.service.PersonaService
...
class PersonaServiceImpl(
    ...
    override fun list(ownerId: Long): List<PersonaResponse> = repository.findByOwnerIdOrderByCreatedAtAsc(ownerId).map { it.toResponse() }
