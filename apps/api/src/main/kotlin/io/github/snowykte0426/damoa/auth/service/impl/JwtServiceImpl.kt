package io.github.snowykte0426.damoa.auth.service.impl
...
@Service
class JwtServiceImpl(props: AppProperties) : JwtService {
    private val key = props.jwtSecret.toByteArray()
    private val ttlMillis = 7L * 24 * 60 * 60 * 1000

    override fun issue(userId: Long, name: String, email: String): String {
        val now = Date()
    ...
    override fun validate(token: String): Long? = try {
